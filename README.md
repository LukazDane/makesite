...
[![Go Report Card](https://goreportcard.com/badge/github.com/LukazDane/makesite)](https://goreportcard.com/report/github.com/LukazDane/makesite)
...
- [x] Add any third party library to your project to enhance it's functionality. Some ideas you might consider include **_(CHOOSE ONLY ONE)_**:
  ...
  - [x] **_FILL IN THE BLANK_**: `I will use the Spotify library. The documentation is located at https://github.com/zmb3/spotify. My goal is to use it to play a song.`
- [x] **Add, commit, and push to GitHub**.
